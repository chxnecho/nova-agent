...
const { escapeHtml, highlight, renderInline, renderMarkdown, humanizeError } =
  (typeof window !== "undefined" && window.NovaMarkdown) || require_md_fallback();

function require_md_fallback() {
  // Never reached in the browser: markdown.js always loads before app.js.
  throw new Error("NovaMarkdown not found — is /static/markdown.js loaded?");
}
...
/* ---------------- markdown & error mapping (now in markdown.js) ---------------- */
...
/* ---------------- human-friendly error mapping (now in markdown.js) --------- */
/* ---------------- chat streaming ---------------- */
